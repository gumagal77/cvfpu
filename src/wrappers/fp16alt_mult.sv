module fp16alt_mult #(localparam WIDTH = 16) (
	input logic                               clk_i,
  	input logic                               rst_ni,
	// Input signals
...
fpnew_fma_mini #(.FpFormat(fpnew_pkg::FP16ALT), .NumPipeRegs(0), .PipeConfig(fpnew_pkg::BEFORE)) multiplier 
           (.clk_i, .rst_ni, .operands_i({{(WIDTH){1'd0}},b_i,a_i}),
