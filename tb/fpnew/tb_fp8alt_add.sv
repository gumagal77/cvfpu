...
string input_file_path = "fp8alt_add_input.txt";
...
function automatic logic [WIDTH-1:0] get_fp_value (
    ...
    $display("GET FP Value: MAX_VALUE_INT %d", MAX_VALUE_INT);
    $display("GET FP Value: BIAS %d", BIAS);
    $display("GET FP Value: abs_real_value %g", abs_real_value);
    $display("GET FP Value: int_value %d", int_value);
